...
interface BadgeProps {
  ...
  variant?: 'default' | 'success' | 'warning' | 'danger' | 'info' | 'purple' | 'gold' | 'amber';
  className?: string;
  dot?: boolean;
}
...
export const Badge: React.FC<BadgeProps> = ({
  ...
  const styles = {
    ...
    amber: 'bg-amber-50 dark:bg-amber-950/50 text-amber-700 dark:text-amber-300 border-amber-200/80 dark:border-amber-800/80',
  };
