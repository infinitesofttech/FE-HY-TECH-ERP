...
export const CardFooter: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  ...
  <div
    className={`px-5 sm:px-6 py-3.5 border-t border-slate-100 dark:border-slate-800/80 bg-slate-50/50 dark:bg-slate-950/30 rounded-b-2xl flex items-center justify-between gap-4 ${className}`}
    {...props}
  >
    {children}
  </div>
