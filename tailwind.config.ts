  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-elevated': '0 10px 30px -10px rgba(0, 0, 0, 0.06), 0 4px 6px -2px rgba(0, 0, 0, 0.02)',
        'card-hover': '0 20px 40px -15px rgba(5, 150, 105, 0.18), 0 8px 10px -4px rgba(0, 0, 0, 0.03)',
